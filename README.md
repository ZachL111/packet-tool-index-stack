...
packet-tool-index-stack is a Python project for cli tools. It focuses on this technical goal: Package a Python local lab for index analysis with append-only fixtures, checkpoint recovery checks, and documented operating limits.
